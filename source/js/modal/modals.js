export class Modals {
  constructor(settings = {}) {
    this._scrollLock = window.scrollLock;
    this._focusLock = window.focusLock;
  ...
  open(modalName = this._modalName) {
    ...
    if (this._openedModalElement) {
      this._scrollLock.enableScrolling(this._openedModalElement);
      this._scrollLock.disableScrolling(modal);
  ...
  close(modalName = this._modalName) {
    ...
    if (this._enableScrolling) {
      setTimeout(() => {
        this._scrollLock.enableScrolling(modal);
      }, this._eventTimeout);
    }
